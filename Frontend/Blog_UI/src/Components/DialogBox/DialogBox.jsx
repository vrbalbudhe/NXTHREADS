  ...
  return (
    isOpen && (
      <div className="fixed inset-0 flex justify-center items-center backdrop-blur-sm bg-gray-900 bg-opacity-50 z-50">
        <div className="w-72 max-w-sm p-6 border-2 border-gray-700 shadow-lg rounded-lg bg-darkPostCardBackground">
          <div className="mb-4">
            <h1 className="text-sm font-medium text-gray-200">{message}</h1>
          </div>
